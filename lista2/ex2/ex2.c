#include <stdio.h>//protótipo da função quad, sem retorno com parâmetro inteiro como entrada
void quad(int x);//protótipo da função quad, sem retorno com parâmetro inteiro como entrada
void dobro(int x);//protótipo da função dobro: sem retorno e parâmetro de entrada do tipo inteiro
